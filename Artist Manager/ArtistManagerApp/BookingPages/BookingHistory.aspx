<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookingHistory.aspx.cs" Inherits="ArtistManagerApp.BookingPages.BookingHistory" %>
...
box-shadow: inset 0 0.15625em 0.25em rgba(0, 0, 0, 0.15), 0 1px 0.15625em rgba(0, 0, 0, 0.05);
    ...
    <form id="form1" runat="server">
        ...
        <div class="container">
                        ...
                        <div class="row" align="center">
                            <div class="auto-style4" align="center">
                                <strong style="color:white;" ><asp:Label ID="OrderAmountLabel" runat="server" Font-Bold="True" Font-Overline="False" Font-Size="XX-Large" Text="Booking History"  CssClass="img-fluid" ForeColor="white"></asp:Label></strong>
                            </div>
                        </div>
                        <br /> <br />
                 <div class="row" align="center">
        ...
        <div class="table-responsive" align="center">
            ...
            <div style="width: 95%; height: 800px; overflow: auto" >
