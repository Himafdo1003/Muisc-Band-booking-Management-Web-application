<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConfirmedBookings.aspx.cs" Inherits="ArtistManagerApp.BookingPages.ConfirmedBookings" EnableEventValidation="false" ValidateRequest="false" %>
...
border-radius: 10px;  
        ...
        <div class="container">
                        ...
                        <div class="row" align="center">
                            <div class="col" align="center">
                                <strong style="color:white;" ><asp:Label ID="OrderAmountLabel" runat="server" Font-Bold="True" Font-Overline="False" Font-Size="XX-Large" Text="Confirmed Bookings"  CssClass="img-fluid" ForeColor="white"></asp:Label></strong>
                            </div>
                        </div>
                        <br /> <br />
 ...
 <div class="container" >
    ...
    <ContentTemplate>
               ...
               <asp:TextBox ID="EventDateTB"  runat="server" CssClass="TB" Font-Bold="True" Font-Size="Medium" Height="50px" Width="220px" ReadOnly="True"   TextMode="Date"  ></asp:TextBox>
            ...
            <%--   <asp:TextBox ID="EventTimeTB"  runat="server" Font-Bold="True" CssClass="TB" Font-Size="Medium" Height="50px" Width="220px" ReadOnly="True"    ></asp:TextBox>--%>
         ...
         <asp:DropDownList ID="EventTimeDropdown" runat="server" Font-Bold="True" CssClass="TB" Font-Size="Medium" Height="50px" Width="220px" ReadOnly="True"   Enabled="False">
              ...
              <%-- <asp:TextBox ID="EventTypeTB"  CssClass="TB" runat="server" Font-Bold="True" Font-Size="Medium" Height="50px" Width="220px" ReadOnly="True"    ></asp:TextBox>--%>
    ...
    <ContentTemplate>--%>
      ...
      <br /><br />
         ...
         <asp:Button ID="AdvancePayBtn" runat="server" Text="Pay Advance" Font-Bold="True" CssClass="button" Font-Size="Medium" Width="180px" Height="80px" OnClick="PayAdvanceBtn_Click"    />
        
                   
      <br /><br />
         <asp:Button ID="Confirm_Btn" runat="server" Text="Invoice Generate" Font-Bold="True" CssClass="button" Font-Size="Medium" Width="180px" Height="80px" OnClick="Invoice_Btn_Click"   />
