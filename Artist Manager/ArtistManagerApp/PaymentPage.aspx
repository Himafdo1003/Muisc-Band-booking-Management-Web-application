<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentPage.aspx.cs" Inherits="ArtistManagerApp.PaymentPage" %>
...
border-radius: 10px;  
  ...
  <a runat="server" id="A2" class="btn btn-sm animated-button victoria-one" visible="false" onserverclick="Without_Click" OnClientClick="return confirm('Are you sure to proceed without Payment?');">Confirm Without Advance</a>
