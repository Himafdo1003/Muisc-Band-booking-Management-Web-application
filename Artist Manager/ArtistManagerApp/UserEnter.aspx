<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserEnter.aspx.cs" Inherits="ArtistManagerApp.UserEnter" EnableEventValidation="false" %>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="myRightCtn">
                            <div class="box"><header>Gravity Smart Calendar</header>
                            
                            <p>Gravity, under the leadership of Mr.Kavisha Fernando was established as a musical band in 2019 and now has marked it’s acme in the music industry of Australia winning the hearts of millions both locally and globally with the newness and the remarkable change it has brought to the industry as a versatile band covering a wide range of music genres such as pop, semi-rock, and western classical. </p>
