<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentsMenu.aspx.cs" Inherits="MariansArtistMangerApp.PaymentsMenu" %>
...
<a runat="server" id="A1" class="btn btn-sm animated-button victoria-one" onserverclick="StaffPay_Click">Staff Payments</a>
              ...
              <div class="col-sm-6">
                  ...
                  <a runat="server" id="A2" class="btn btn-sm animated-button victoria-one" onserverclick="EventPay_Click">Event Payments</a>
