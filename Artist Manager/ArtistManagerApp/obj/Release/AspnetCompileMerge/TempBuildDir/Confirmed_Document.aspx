<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Confirmed_Document.aspx.cs" Inherits="MariansArtistMangerApp.Confirmed_Document" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="table-responsive"> 
           ...
           <tr>
               ...
               &nbsp;    <asp:Label ID="Label15" runat="server" Text="ONLY." Font-Bold="True" ForeColor="Red" Font-Underline="False" Font-Size="Medium" ></asp:Label>
                  ...
                  <tr align="left">
               <td colspan="5">
              This Agreement is entered into on this <asp:Label ID="DateLBL" runat="server" Font-Bold="True"></asp:Label><asp:Label ID="SuffixLBL" runat="server" Font-Bold="True" ></asp:Label>  of <asp:Label ID="MonthLBL" runat="server" Font-Bold="True"></asp:Label> <asp:Label ID="YearLBL" runat="server" Font-Bold="True"></asp:Label>  between <b>MARIANS</b> a musical band established in Sri Lanka and having its registered address at 
                   <b>345/2, Thimbirigaskatuwa Road, Dalupotha, Negombo, Sri Lanka</b> (Hereinafter referred to as the “BAND” and which shall include its successor and assigns) and <asp:Label ID="CustomerNameLBL" runat="server" Font-Bold="True"></asp:Label> holder of National Identity Card No.<asp:Label ID="NICNOlbl" runat="server" Font-Underline="True" Font-Bold="True"></asp:Label> (Hereinafter referred to as the “CUSTOMER” and which shall include its successors and assigns)  (Each a “Party” and together the “Parties”).
</td>
           </tr>
      ...
      <td align="right" style="vertical-align: top;" colspan="1"> b.  </td>
             	...
             	CUSTOMER should settle the balance payment of <asp:Label ID="Label6" runat="server" Text="Rs." Font-Bold="True" ForeColor="#33CC33"></asp:Label> <asp:Label ID="BalanceAmountLBL" runat="server" Font-Bold="True" ForeColor="#33CC33"></asp:Label> by handing it over to BAND Office located at 
                                   <b>345/2, Thimbirigaskatuwa Road, Dalupotha, Negombo, or deposit to </b> <asp:Label ID="Label7" runat="server" Text="Marians Account 1430010500 of Commercial bank at Chilaw branch " Font-Bold="True" ForeColor="Red"></asp:Label>
...
<%--  <tr align="center">
  ...
  CUSTOMER here by agree to arrange a reserved table exclusively for 
                                   ...
                                   of the BAND in coordination with the hotel management and a board to be displayed on the table “RESERVED FOR MARIANS BAND”. Also, the table to be placed next to the stage either right or left of the stage. 
 ...
 This Agreement and all transactions entered into hereunder shall be governed by the Laws of Sri Lanka and the Parties submit to the exclusive jurisdiction of the courts of Sri Lanka.
           ...
           We hereby acknowledge the receipt of Advance Payment of <asp:Label ID="Label13" runat="server" Text="Rs." Font-Bold="True" ForeColor="#33CC33"></asp:Label><asp:Label ID="AdvanceAmount2LBL" runat="server" Font-Bold="True" ForeColor="#33CC33"></asp:Label> made to our bank account M C S M Perera (Commercial Bank AC # 1130095162) on <asp:Label ID="AdvancePaymentDateLBL" runat="server" Font-Bold="True"></asp:Label> and confirm the Band booking as per the above terms and conditions in this agreement.
               ...
               <td colspan="5" >
                  ...
                  <tr align="left">
               <td colspan="5">
          Thank you for the booking made with MARIANS and waiting to provide the best of our service at the event on <asp:Label ID="eventdatelbl" runat="server" Font-Overline="False"  Font-Bold="True"></asp:Label>&nbsp; <b>at </b> <asp:Label ID="EventPlacelbl" runat="server" Font-Overline="False"  Font-Bold="True"></asp:Label>.
</td>
           </tr>
               ...
               <td colspan="5" >
                  ...
                  <tr align="left">
               <td colspan="5">
          For and on behalf of MARIANS BAND
</td>
           </tr>
               ...
               <td colspan="4">
                   ...
                   <img src="https://i.imgur.com/6fkbHWa.jpeg" height="50px"   />
</td>
       <td>
