<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer.aspx.cs" Inherits="MariansArtistMangerApp.Customer" %>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="table-responsive">
                                            <asp:GridView ID="GridView1" runat="server" AutoGenerateSelectButton="True" CellPadding="4"  ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Visible="False" Font-Size="medium" width="100%" HorizontalAlign="Center"   >
