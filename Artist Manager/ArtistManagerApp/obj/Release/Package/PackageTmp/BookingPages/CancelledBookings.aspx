<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CancelledBookings.aspx.cs" Inherits="MariansArtistMangerApp.BookingPages.CancelledBookings" %>
        ...
        <div class="container">
                        ...
                        <div class="row" align="center">
                            <div class="col" align="center">
                                <strong style="color:white;" ><asp:Label ID="OrderAmountLabel" runat="server" Font-Bold="True" Font-Overline="False" Font-Size="XX-Large" Text="Cancelled Bookings" Width="320px" CssClass="img-fluid" ForeColor="white"></asp:Label></strong>
                            </div>
                        </div>
                        <br /> <br />
                   </div>
