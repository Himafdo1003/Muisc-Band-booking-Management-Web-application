<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EventPayments.aspx.cs" Inherits="MariansArtistMangerApp.PaymentPages.EventPayments" %>
        ...
        <div class="container">
                        ...
                        <div class="row" align="center">
                            <div class="col" align="center">
                                <strong style="color:white;" ><asp:Label ID="OrderAmountLabel" runat="server" Font-Bold="True" Font-Overline="False" Font-Size="XX-Large" Text="Event Payments" Width="320px" CssClass="img-fluid" ForeColor="white"></asp:Label></strong>
                            </div>
                        </div>
                        <br /> <br />
                   </div>
