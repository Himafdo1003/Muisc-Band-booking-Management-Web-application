<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReservationMenu.aspx.cs" Inherits="MariansArtistMangerApp.ReservationMenu" %>
          ...
          <div class="container"> 
            ...
            <div class="row">
             <div class="col-sm-6" align="right">
                 ...
                 <a runat="server" id="A1" class="btn btn-sm animated-button victoria-one" onserverclick="DirectBooking_Click">Direct Bookings</a>
              ...
              <div class="col-sm-6">
                 ...
                 <a runat="server" id="A2" class="btn btn-sm animated-button victoria-one" onserverclick="ViaAgent_Click">Booking Via Agent</a>
              </div>
               ...
               <div class="col-sm-6" align="right">
                   ...
                   <a runat="server" id="A3" class="btn btn-sm animated-button victoria-two" onserverclick="Practice_Click">Practice</a>
