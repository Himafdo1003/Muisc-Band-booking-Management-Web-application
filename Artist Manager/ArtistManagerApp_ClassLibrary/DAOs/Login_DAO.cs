...
namespace ArtistManagerApp_ClassLibrary.DAOs
{
    public class Login_DAO
    {
        ...
        public Login_DAO()
        {
            ...
            //LocalDataBaseAccess = "Data Source=bayfonter.ddns.net,1433;Initial Catalog=MariansDB;Persist Security Info=True;User ID=Marians;Password=Prison12!;";
            //LocalDataBaseAccess = "Data Source=192.168.1.7,1433;Initial Catalog=AvenraHotelDB;Persist Security Info=True;User ID=CeylonTester;Password=Prison12!;";
            //LocalDataBaseAccess = "Data Source=192.168.1.7,1433;Initial Catalog=MariansDB;Persist Security Info=True;User ID=Marians;Password=Prison12!;";

            LocalDataBaseAccess = "Data Source=220.247.201.230,1433;Initial Catalog=MariansDB;Persist Security Info=True;User ID=rws;Password=Prison12!;";
